			    ...
			    int *val2, long mask)
{
	...
	bool calib = (mask == IIO_CHAN_INFO_RAW) ? false : true;
	int ret;
	...
	case IIO_CHAN_INFO_OFFSET:
		...
		ret = ads1119_single_conversion(st, chan, val, calib);
 ...
 */
static const struct dev_pm_ops ads1119_pm_ops = {
	SET_SYSTEM_SLEEP_PM_OPS(pm_runtime_force_suspend, pm_runtime_force_resume)
	SET_RUNTIME_PM_OPS(ads1119_runtime_suspend, NULL, NULL)
};
